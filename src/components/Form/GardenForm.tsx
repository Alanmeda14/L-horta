      ...
      <div className="flex flex-wrap gap-2 mb-6">
        <AnimatePresence>
          {formData.products.map((product) => {
            const productInfo = productList.find(p => p.id === product.productId);
            return (
              <motion.div
                ...
                <div className="flex items-center gap-2 flex-wrap">
                  ...
                  <select
                    ...
                    onChange={(e) => {
                      setFormData(prev => ({
                        ...prev,
                        products: prev.products.map(p =>
                          p.productId === product.productId ? { ...p, units: e.target.value } : p
                        )
                      }));
                    }}
                    className="border rounded px-2 py-1 text-sm bg-white focus:ring-2 focus:ring-green-300 focus:border-green-500"
                  ...
                  <input
                    ...
                    onChange={(e) => {
                      ...
                      setFormData(prev => ({
                        ...prev,
                        products: prev.products.map(p =>
                          p.productId === product.productId ? { ...p, unitPrice: value } : p
                        )
                      }));
                    }}
                    className="w-20 p-1 border rounded text-center text-sm focus:ring-2 focus:ring-green-300 focus:border-green-500"
                    placeholder="Precio"
                    min="0"
                    step="0.01"
                    /* value={product.price}
                  ...
                  <button
                    ...
                    onClick={() => {
                      setFormData(prev => ({
                        ...prev,
                        products: prev.products.filter(p => p.productId !== product.productId)
                      }));
                    }}
