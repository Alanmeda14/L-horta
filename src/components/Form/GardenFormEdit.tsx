                    ...
                    <div className="w-full">
                        {as === 'textarea' ? (
                            <textarea
                                ...
                                className={`w-full p-2.5 border rounded text-sm focus:ring-2 focus:ring-green-300 focus:border-green-500 transition-all h-24 ${hasError ? 'border-red-500 bg-red-50' : 'border-gray-300'
                                    }`}
                                required={required}
                            />
                        ) : (
                            <input
                                ...
                                value={formData[name] as string}
                                onChange={handleChange}
                                className={`w-full p-2.5 border rounded text-sm focus:ring-2 focus:ring-green-300 focus:border-green-500 transition-all ${hasError ? 'border-red-500 bg-red-50' : 'border-gray-300'
                                    }`}
                                required={required}
                            />
                        )}
                            ...
                            <div className="flex items-center gap-2 flex-wrap">
                                ...
                                <div className="flex items-center border rounded overflow-hidden bg-white">
                                    ...
                                    <input
                                        ...
                                        placeholder={getPriceLabel(product.unidad)}
                                        aria-label={`Precio por ${product.unidad}`}
                                    />
                                </div>
